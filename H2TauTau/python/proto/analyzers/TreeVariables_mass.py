...
event_vars = [
    ...
    Variable('met_pt_DM0_up',  lambda ev: ev.met_pt_DM0_up if hasattr(ev, 'met_pt_DM0_up')  else -999.),
    Variable('met_phi_DM0_up', lambda ev: ev.met_phi_DM0_up if hasattr(ev, 'met_phi_DM0_up') else -999.),
    Variable('met_px_DM0_down', lambda ev: ev.met_px_DM0_down if hasattr(ev, 'met_px_DM0_down') else -999.),  
    Variable('met_py_DM0_down', lambda ev: ev.met_py_DM0_down if hasattr(ev, 'met_py_DM0_down') else -999.), 
    Variable('met_pt_DM0_down',  lambda ev: ev.met_pt_DM0_down if hasattr(ev, 'met_pt_DM0_down')  else -999.),
    Variable('met_phi_DM0_down', lambda ev: ev.met_phi_DM0_down if hasattr(ev, 'met_phi_DM0_down')  else -999.),
    Variable('met_px_DM1_up', lambda ev: ev.met_px_DM1_up if hasattr(ev, 'met_px_DM1_up')  else -999.),
    Variable('met_py_DM1_up', lambda ev: ev.met_py_DM1_up if hasattr(ev, 'met_py_DM1_up') else -999.),
    Variable('met_pt_DM1_up',  lambda ev: ev.met_pt_DM1_up if hasattr(ev, 'met_pt_DM1_up')  else -999.),
    Variable('met_phi_DM1_up', lambda ev: ev.met_phi_DM1_up if hasattr(ev, 'met_phi_DM1_up')  else -999.),
    Variable('met_px_DM1_down', lambda ev: ev.met_px_DM1_down if hasattr(ev, 'met_px_DM1_down')  else -999.),
    Variable('met_py_DM1_down', lambda ev: ev.met_py_DM1_down if hasattr(ev, 'met_py_DM1_down') else -999.),
    Variable('met_pt_DM1_down',  lambda ev: ev.met_pt_DM1_down if hasattr(ev, 'met_pt_DM1_down') else -999.),
    Variable('met_phi_DM1_down', lambda ev: ev.met_phi_DM1_down if hasattr(ev, 'met_phi_DM1_down') else -999.),
    Variable('met_px_DM10_up', lambda ev: ev.met_px_DM10_up if hasattr(ev, 'met_px_DM10_up') else -999.),
    Variable('met_py_DM10_up', lambda ev: ev.met_py_DM10_up if hasattr(ev, 'met_py_DM10_up') else -999.),
    Variable('met_pt_DM10_up',  lambda ev: ev.met_pt_DM10_up if hasattr(ev, 'met_pt_DM10_up') else -999.),
    Variable('met_phi_DM10_up', lambda ev: ev.met_phi_DM10_up if hasattr(ev, 'met_phi_DM10_up') else -999.),
    Variable('met_px_DM10_down', lambda ev: ev.met_px_DM10_down if hasattr(ev, 'met_px_DM10_down') else -999.),
    Variable('met_py_DM10_down', lambda ev: ev.met_py_DM10_down if hasattr(ev, 'met_py_DM10_down') else -999.),
    Variable('met_pt_DM10_down',  lambda ev: ev.met_pt_DM10_down if hasattr(ev, 'met_pt_DM10_down') else -999.),
    Variable('met_phi_DM10_down', lambda ev: ev.met_phi_DM10_down if hasattr(ev, 'met_phi_DM10_down')  else -999.),
    Variable('met_px_JetEnUp', lambda ev: ev.met_px_JetEnUp if hasattr(ev, 'met_px_JetEnUp') else -999.),
    Variable('met_py_JetEnUp', lambda ev: ev.met_py_JetEnUp if hasattr(ev, 'met_py_JetEnUp')  else -999.),
    Variable('met_pt_JetEnUp',  lambda ev: ev.met_pt_JetEnUp if hasattr(ev, 'met_pt_JetEnUp') else -999.),
    Variable('met_phi_JetEnUp', lambda ev: ev.met_phi_JetEnUp if hasattr(ev, 'met_phi_JetEnUp') else -999.),
    Variable('met_px_JetEnDown', lambda ev: ev.met_px_JetEnDown if hasattr(ev, 'met_px_JetEnDown')  else -999.),
    Variable('met_py_JetEnDown', lambda ev: ev.met_py_JetEnDown if hasattr(ev, 'met_py_JetEnDown') else -999.),
    Variable('met_pt_JetEnDown',  lambda ev: ev.met_pt_JetEnDown if hasattr(ev, 'met_pt_JetEnDown') else -999.),
    Variable('met_phi_JetEnDown', lambda ev: ev.met_phi_JetEnDown if hasattr(ev, 'met_phi_JetEnDown') else -999.),
    Variable('met_px_UncEnUp', lambda ev: ev.met_px_UncEnUp if hasattr(ev, 'met_px_UncEnUp') else -999.),
    Variable('met_py_UncEnUp', lambda ev: ev.met_py_UncEnUp if hasattr(ev, 'met_py_UncEnUp') else -999.),
    Variable('met_pt_UncEnUp',  lambda ev: ev.met_pt_UncEnUp if hasattr(ev, 'met_pt_UncEnUp') else -999.),
    Variable('met_phi_UncEnUp', lambda ev: ev.met_phi_UncEnUp if hasattr(ev, 'met_phi_UncEnUp') else -999.),
    Variable('met_px_UncEnDown', lambda ev: ev.met_px_UncEnDown if hasattr(ev, 'met_px_UncEnDown') else -999.),
...
# generic particle
particle_vars = [
    Variable('genMass', lambda p: p.genMass if hasattr(p, 'genMass') else -999),
...
# tau
tau_vars = [
    Variable('unscaledPt', lambda tau : tau.unscaledP4.pt() if hasattr(tau,'unscaledP4') else -99),
    Variable('TES_down_pt', lambda tau : tau.TES_downP4.pt() if hasattr(tau,'TES_downP4') else -99),
    Variable('TES_up_pt', lambda tau : tau.TES_upP4.pt() if hasattr(tau,'TES_upP4') else -99),
