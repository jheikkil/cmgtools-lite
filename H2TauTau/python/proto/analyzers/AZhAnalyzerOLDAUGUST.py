...
#        print "LET US MAKE A Z"
    ...
    def process(self, event):
        ...
        if not self.cfg_ana.applyIDISO:
            ...
            electronsGOOD = [ electron for electron in electrons if electron.pt()>10 and abs(electron.eta())<2.5 and abs(electron.dxy()) < 0.045 and abs(electron.dz()) < 0.2 and electron.mvaIDRun2('Spring16', 'POG90') and electron.passConversionVeto() and electron.relIsoR(R=0.3, dBetaFactor=0.5, allCharged=0) < 0.3]
      ...
      #  print len(leptons_me)
       ...
       #         print lep1
       #         print lep2
       #         print "lep 1 global and tracker values:"
       #         print lep1.isGlobalMuon()
       #         print lep1.isTrackerMuon()
       #         print "lep2 global and tracker values:"
       #         print lep2.isGlobalMuon()
       #         print lep2.isTrackerMuon()
       #         print "TOO CLOSE, LEMME EXIT"
       #         return False 
