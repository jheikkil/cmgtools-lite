...
class zhTriggerSF :
    ...
    def __init__( self, zType ):
        ...
        self.sfFile = ROOT.TFile( '/afs/cern.ch/work/t/truggles/public/zhAnalysis/zhTriggerSFs_2016Full_extended.root', 'r' )
    ...
    def __call__(self,event):
        ...
        #print "tyyppi onkin", self.zType
        #print "meidan SF on", SF
...
MODULES = [
 ( 'triggerSF_EETT', lambda : zhTriggerSF("ZEE") ),
 ( 'triggerSF_EEET', lambda : zhTriggerSF("ZEE") ),
 ( 'triggerSF_EEEM', lambda : zhTriggerSF("ZEE") ),
 ( 'triggerSF_EEMT', lambda : zhTriggerSF("ZEE") ),
 ( 'triggerSF_MMTT', lambda : zhTriggerSF("ZMM") ),
 ( 'triggerSF_MMET', lambda : zhTriggerSF("ZMM") ),
 ( 'triggerSF_MMEM', lambda : zhTriggerSF("ZMM") ),
 ( 'triggerSF_MMMT', lambda : zhTriggerSF("ZMM") ) ]
