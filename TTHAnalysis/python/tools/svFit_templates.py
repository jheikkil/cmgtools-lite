...
class svFit_classic:
    def __init__(self, channel):
        self.branches = ["H_LT_DM0_up", "H_LT_DM0_dn", "H_LT_DM1_up", "H_LT_DM1_dn", "H_LT_DM10_up", "H_LT_DM10_dn", "H_LT_JEC_up", "H_LT_JEC_dn", "H_LT_UEC_up", "H_LT_UEC_dn",
    ...
    def __call__(self,event):
        ...
        #print "Testing: mZ and Zunscaled", mZ, Zunscaled.M(), ZTESTI.M() 
        ...
        if self.channel in ["EEET", "MMET", "EEMT", "MMMT", "EETT", "MMTT"] and genmatch_4==5:
            if DM4==0:
        ...
        if self.channel in ["EETT", "MMTT"] and genmatch_3==5:
            if DM3==0:
        ...
        if self.channel in ["EETT", "MMTT"]:
            if DM3 == 0 and DM4 == 0:
                DM1_nominal = 1
                DM10_nominal = 1
            elif DM3 == 1 and DM4 == 1:
                DM0_nominal = 1
       	       	DM10_nominal =	1
            elif DM3 == 10 and DM4 == 10: 
         	DM0_nominal = 1
       	       	DM1_nominal = 1
            elif (DM3 == 0 and DM4 == 1) or (DM3 == 1 and DM4 == 0):
       	       	DM10_nominal =	1
       	    elif (DM3 == 0 and DM4 == 10) or (DM3 == 10 and DM4 == 0):
                DM1_nominal = 1
            elif (DM3 == 1 and DM4 == 10) or (DM3 == 10 and DM4 == 1):
                DM0_nominal = 1
        elif self.channel in ["EEET", "MMET", "EEMT", "MMMT"]: #and gen_match_4==5
            if DM4==0:
                DM1_nominal = 1
                DM10_nominal = 1
            elif DM4==1:
