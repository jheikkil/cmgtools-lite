...
python makeShapeCardsSusy.py mcaET_skimDATA.txt cuts_ET_SS.txt A_svFit_constrained 30,0,600 systs_AZh.txt \
-P data_SS --skimPath \
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/MMET/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/EEET/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
python makeShapeCardsSusy.py mcaTT_skimDATA.txt cuts_TT_SS.txt A_svFit_constrained 30,0,600 systs_AZh.txt \
-P data_SS --skimPath \
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/EETT/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/MMTT/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
python makeShapeCardsSusy.py mcaMT_skimDATA.txt cuts_MT_SS.txt A_svFit_constrained 30,0,600 systs_AZh.txt \
-P data_SS --skimPath \
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/MMMT/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/EEMT/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
python makeShapeCardsSusy.py mcaEM_skimDATA.txt cuts_EM_SS.txt A_svFit_constrained 30,0,600 systs_AZh.txt \
-P data_SS --skimPath \
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/MMEM/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
...
--Fs sf/t masses_SS/{cname}.root \
--FMC sf/t scalesMC_July8/{cname}.root \
   --od /afs/cern.ch/work/j/jheikkil/testaus/CMSSW_9_4_6_patch1/src/HiggsAnalysis/CombinedLimit/1504_SS_final/EEEM/Aconstr_HsvFit90 -l 35.9 -A "entry point" zeroMass "H_svFit_constrained > 0 && H_svFit>90 && H_svFit<180 && A_svFit_constrained<600" \
