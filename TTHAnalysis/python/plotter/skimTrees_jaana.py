...
def _runIt(args):
        ...
        if options.skimpath:
            #os.system("cd mysource")
            #os.system("cd ..")
            print mysource2
            mysource2 = mysource.split('/', 8)
            mysource2 = "/".join(mysource.split('/')[:-1])
            mysource2 = os.system("pwd")
            print mysource2
            os.system("cp -r %s/SkimAnalyzerCount %s/" % (mysource2,myoutpath))
        else:# not options.skimpath:
        ...
        if not options.oldstyle:
            #print options.tree
            #print "%s/%s.root" % (myoutpath,options.tree)
